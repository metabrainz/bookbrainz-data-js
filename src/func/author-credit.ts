...
function findAuthorCredit(
	...
	authorCredit: Array<AuthorCreditNameT>
) {
	const tables = {
		cc: 'bookbrainz.author_credit'
	};
...
export function updateAuthorCredit(
	...
	function comparisonFunc(obj: AuthorCreditNameT, other: AuthorCreditNameT) {
	...
	const oldCreditNames: Array<AuthorCreditNameT> = oldCredit ?
		_.orderBy(oldCredit.related('names').toJSON(), 'position') :
		[];
