...
import type {
	...
	FormIdentifierT as Identifier,
	Transaction
} from './types';
import {
	getAdditionalEntityProps,
...
export async function createEntity({
	...
	const annotationPromise = revisionPromise.then((revision) =>
		updateAnnotation(orm, transacting, null, annotation, revision));
